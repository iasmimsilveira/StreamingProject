...
using StreamingProject.Domain.Transaction.Aggregates;
using System;
...
namespace StreamingProject.Domain.Account.Aggregates
{
    public class Cartao
    {
        ...
        public List<Transaction.Aggregates.Transacao> Transacoes { get; set; }

        public Cartao()
        {
            this.Transacoes = new List<Transaction.Aggregates.Transacao>();
        }
        ...
        private void VerificaLimiteDisponivel(Transaction.Aggregates.Transacao transacao, CartaoException validationErrors)
        {
        ...
        private void ValidarTransacao(Transaction.Aggregates.Transacao transacao, CartaoException validationErrors)
        {
